...
--                                                 Source: docs/_posts/2024-07-07-3810.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2024-07-07-3810",
    description = {
        "# Game Version 3810",
        "",
        "## Bug Fixes",
        ...
        "",
        "- (#5895) After receiving several buffs, the Seraphim Tech 3 Submarine Hunter has become too oppressive, especially in larger formations.",
        "  These changes aim to bring it back in line, while preserving its identity.",
        "",
        ...
        "",
        "  Previously, Chrono was synced to game time to prevent stun locking. Now, units have a cooldown before they can be stunned by any Chrono,",
        "  which prevents stun locking while allowing the new Chrono to be more responsive.",
        "",
        ...
        "    - Speed: 3.5 -> 3.3",
        "",
        "  This brings its DPS closer in line with other factions. It can now take out a strategic bomber in 3 salvo's instead of 4. And with the",
        "  increased movement speed it can better keep up to Titans and Parashields. Swapping the speed with Redeemer maintains a semblance of",
        "  faction diversity. Redeemer was chosen because it doesn't really need its speed due to asylums being far too quick (4.0) to keep up with,",
        "  and harbingers being relatively slow at 3.0 speed.",
        "",
        "- (#6060, #6296) Make static shields absorb ACU explosions.",
        "",
        "  Static shields absorb full damage from ACU explosions. For example, this prevents ACU explosions from killing all engineers inside",
        "  shielded bases/firebases. Mobile shields do not absorb damage from ACU explosions because the ACU explosion is an anti-snowball mechanic",
        "  and it would be very unfair for Aeon and UEF T2 to ignore it.",
        "",
        ...
        "    - AoE (Cybran): 3",
        "",
        "- (#6103) Greatly increase Othuum's maneuverability and slightly increase the range of its short range guns to make it better in early T3",
        "  rushes and T3 raids.",
        "",
        ...
        "",
        "  After being fixed a long time ago, the adjacency bonus made Salvation more effective than Mavor as a game ending artillery as recently",
        "  discovered. Since Salvation's purpose is to be spammed en masse after a Paragon, and not to be built independently as a superior artillery",
        "  piece, the adjacency bonus that makes building Salvation without Paragon overpowered is nerfed.",
        "",
        ...
        "    - Health: 1750 --> 2000",
        "",
        "- (#6235) Tone down the Tempest, as it has become too oppressive and snowballed too quickly. Most importantly, its extremely powerful depth",
        "  charges now fire once every 6 seconds instead of once every 5 seconds and have a reduced range. Additionally, the amount of mass required",
        "  for it to attain one level of veterancy is increased from 12k to 18k.",
        "",
        ...
        "",
        "- (#6202) Increase the energy maintenance cost of the Barracuda (Cybran T2 Sub) from 30 to 45. This makes it more of a choice to enable the",
        "  stealth, similar to how it is for the Cybran ASF.",
        "",
        "- (#6211) Increase the velocity and lifetime of the Wailer's AA-missiles, since they often expired before they were able to reach their",
        "  target.",
        "",
        ...
        "",
        "- (#6043) The `BuildRate` and `BuildTime` stats of all Radars and Sonars are updated to be more streamlined. The build time of Tech 2 Sonars",
        "  is corrected to ensure it is not longer than that of Tech 3 Sonars. Tech 3 Sonars get their very low build time increased, to compensate",
        "  for their Tech 2 counterparts being much quicker to build and providing more build power.",
        "",
        "  - Tech 1 Radars:",
        "    - BuildRate: 14.08 --> 13",
        "  - Tech 2 Radars:",
        ...
        "",
        "- (#6082) The `BuildRate` and `BuildTime` statistics of several shield generators are updated to be more streamlined. The Seraphim Tech 2",
        "  Shield Generator gains build power, as it previously had a very low amount. The Aeon Tech 2 Shield Generator loses its build power, as it",
        "  cannot be upgraded.",
        "",
