...
--                                                 Source: docs/_posts/2023-03-05-3754.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-03-05-3754",
    description = {
        ...
        "",
        "- (#4759) Fix beam weapons continuously restarting as they ground fire This also fixes the bug where beam weapons that are firing on the",
        "  ground apply the damage twice",
        "",
        ...
        "## AI",
        "",
        "We would like to remind people that there are various mods that provide different AI experiences. We can highly recommend you to download",
        "them from the vault and give them a spin.",
        "",
        ...
        "hundreds of hours. We're hoping to find additional contributors that have an interesting in creating (and fixing) meshes and textures. If",
        "you have that interest and/or experience and you'd like to help out then you can introduce yourself in the dedicated channels in the",
        ...
        "## Contributors",
        "",
        "RabidPope (#4719) Relentor (#4674) Rowey (#4752) Jip (#4745, #4756, #4743, #4757, #4759, #4761, #4763, #4762, #4778, #4777, #4776, #4768,",
        "#4780, #4782, #4719) Wotan (#4745) SlinkingAnt (#4755, #4783) 4z0t (#4771, #4758)"
    }
}
