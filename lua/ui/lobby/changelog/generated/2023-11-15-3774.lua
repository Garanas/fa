...
--                                                 Source: docs/_posts/2023-11-15-3774.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-11-15-3774",
    description = {
        ...
        "",
        "Add more debug functionality for state machines, making it easier for developers to visualize the state machine's objectives by selecting",
        "its units.",
        "",
        "## Graphics",
        "",
