...
--                                                 Source: docs/_posts/2023-09-09-3766.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-09-09-3766",
    description = {
        ...
        "",
        "In the previous patch, we reduced the ability to cap structures by assisting a structure. Thanks to an assembly patch by 4z0t, the technical",
        "reasons for this reduction have been fixed. As a result, we are now reintroducing the feature with improvements.",
        "",
        "The feature now sorts the build orders by the distance to the nearest engineer relative to the structure they are assisting. This helps",
        "reduce pathfinding issues. Additionally, the feature now applies a single build order to all engineers, which reduces the framerate impact",
        "that players previously experienced.",
        "",
