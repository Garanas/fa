...
--                                                 Source: docs/_posts/2023-12-31-3778.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-12-31-3778",
    description = {
        ...
        "",
        "There was an unforeseen strategy that one can apply when teleporting a UEF ACU with a Billy. The Billy enhancement now occupies the same",
        "slot as the teleport enhancement again.",
        "",
        ...
        "",
        "Due to a bug, the Volcano had a target check interval of 1.0 seconds instead of 0.4 seconds, making it unable to reliably catch Seraphim",
        "tactical missiles due to their speed.",
        "",
