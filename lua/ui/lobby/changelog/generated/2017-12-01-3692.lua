...
--                                                 Source: docs/_posts/2017-12-01-3692.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2017-12-01-3692",
    description = {
        ...
        "  - This mode will be developed into a fully integrated game mode down the line. It should open up extensive interesting new options for",
        "    gameplay.",
        "",
        "### Gameplay",
        "",
        ...
        "- Added above water target bone to Cybran T1 Torpedo Launcher to allow it to be attacked by surface units, particularly the Seraphim",
        "  Destroyer",
        ...
        "- Refined some UI tips. Engineers now display \"Engineering Suite\" only, with \"Reclaims\" and \"Repairs\" being saved for special case units",
        "  like the Harbinger",
        "",
        "### Lobby",
        "",
