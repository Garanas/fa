...
--                                                 Source: docs/_posts/2023-12-24-3777.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-12-24-3777",
    description = {
        ...
        "",
        "The range of the dummy weapon indicates where the shield hits the water line. The dummy weapon prevents the Bulwark from sailing right into",
        "the enemy fleet when you issue an attack move order. It roughly remains at the same range as frigates.",
        "",
        ...
        "",
        "This primarily impacts the Zeus, Scorcher, and the Janus. The behavior is only different when the target is trying to evade the bomber. The",
        "overall behavior should be more consistent now with that of other bombers.",
        "",
        ...
        "",
        "The Aeon tech 3 missile ship is now cheaper to build. It fires more missiles that deal less damage but in a larger damage radius. The unit",
        "is now more equipped to overwhelm tactical missile defenses and deal damage in a wide area surrounding the target.",
        "",
        "- (#5769) Rework of strategic missile submarines.",
        "",
        "All non-experimental units with strategic missile launchers now have a 10-second reload time on their strategic missile launchers. The",
        "stationary strategic missile launchers were already affected by this reload time. It primarily applies to the strategic submarines and the",
        "Seraphim battleship.",
        "",
        "- (#5715) Increase the range of the stealth field of the Deceiver by 1.",
        "",
        "Unlike what the game makes you believe, intel works in a grid-like fashion. The cell size of stealth field intel is 4. Therefore, the",
        "previous increase of the radius from 20 to 23 has effectively no impact. The Deceiver now receives the buff it was intended to receive after",
        "increasing the vision range of a wide range of units.",
        "",
        "## Features",
        "",
        ...
        "",
        "The lingering unit may not have been visible, but it does have gameplay impact. The lingering unit could for example block the placement for",
        "structures.",
        "",
        "- (#5769) Fix the bug where the UEF Strategic Missile Submarine is able to fire multiple missiles in a single salvo.",
        "",
        "This could give the unit a negative missile silo count. The negative count would trigger all sorts of other bugs, such as the ability to",
        "launch missiles indefinitely.",
        "",
