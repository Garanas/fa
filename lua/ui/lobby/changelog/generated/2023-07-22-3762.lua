...
--                                                 Source: docs/_posts/2023-07-22-3762.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-07-22-3762",
    description = {
        ...
        "",
        "  You can now build on top of logs, bushes, cacti, (fallen) trees and tree groups. This is a quality-of-life change to prevent your ACU or",
        "  your engineers from delaying your build order because there is an invisible prop (due to Level of Details (LODs)) 'blocking' your",
        "  construction site. This can significantly delay the construction. Instead, the before-mentioned props are destroyed when you start the",
        "  construction.",
        "",
        ...
        "",
        "  For the next patch, the goal is to allow you to entirely rely on the reclaim overview to manage your expectations of whether the",
        "  construction site is blocked by props.",
        "",
        "- (#5246) Do not immediately destroy units of teams that recall",
        "",
        "  There was a suggestion on the forum to be able to review the final game state when a team recalls. With this delay, the units are",
        "  preserved in the final game state, yet still destroyed when you play FFA-like setups",
        "",
        ...
        "",
        "  They were categorized by AI as a unit with excessive surface threat, instead of economic threat. As a result, the AI would essentially",
        "  never attack a base with a nuke launcher in it",
        "",
        "- (#5234) Fix a bug where mobile artillery and missile launchers did not generate the correct threat",
        "",
        "  They were categorized by the AI as units with economic threat instead of surface threat. As a result, the AI would recognize them as bulky",
        "  engineers instead of something more dangerous",
        "",
