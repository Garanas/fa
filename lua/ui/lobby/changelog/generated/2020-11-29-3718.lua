...
--                                                 Source: docs/_posts/2020-11-29-3718.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2020-11-29-3718",
    description = {
        ...
        "    - Hunter",
        "      - Health: 65 → 90",
        "    - Mech Marine Mass Cost: 35 → 30 Power Cost: 120 → 100 Build Time: 120 → 100 Health: 75 → 60 Speed: 4 → 4.2 Turnrate: 45 → 50",
        "      TurretYawSpeed: 180 → 200",
        "    - Selen Build Time: 80 → 90 Speed: 4 → 3.8 Range: 16 → 18 Turret SlavedToBody: True → False TurretYawRange: 30 → 360 TurretYawSpeed: 180",
        "      → 120",
        "  - Tech 2 Land",
        "    - Mongoose",
        "      - MaxSpeed: 3.2 → 2.8",
        ...
        "    - Radar Stealth: 45 → 70",
        "  - Yolona-Oss",
        "    - The Yolona-Oss has its animation reduced to increase the speed of its firing cycle. It also explodes like other strategic missile",
        "      launchers when killed.",
        "  - Death Weapon",
        ...
        "- Miscellaneous",
        "  - Overcharge",
        "    - Overcharge is changed from a variable system to a fixed damage per energy used. The ratio is 1:4 damage to energy drained and the",
        "      minimum damage is 1250, maintaining the minimum energy required to Overcharge at 5k.",
