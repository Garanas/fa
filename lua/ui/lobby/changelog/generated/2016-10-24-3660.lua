...
--                                                 Source: docs/_posts/2016-10-24-3660.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2016-10-24-3660",
    description = {
        ...
        "- Added new feature: Kick Reasons. When kicking a player from your lobby, you get a new dialog. You may type in a reason for the kick to",
        "  notify the player. If you blank it, or leave the message as presented, it will play the old message.",
        ...
        "- Added new unit share conditions for interesting new gameplay. \"Full Share\" and \"Share Until Death\" have been joined by \"Traitors\", which",
        "  gifts all your units to the player who killed you (Very interesting for FFA games), \"Defectors\", which is the opposite of Full Share,",
        "  gifting your units to the highest scoring enemy, and \"Civilian Desertion\", which gifts your units to a neutral civilian AI, if there is",
        "  one.",
        "- Improved the tooltip when hovering over your score in the lobby. It will now show a more detailed explanation including your rating",
        "  deviation",
        ...
        "- New feature: Delayed Unit Transfer. Hold shift while giving a unit to another player to have it transfer once it finishes the command",
        "  queue. Particularly useful when used with transports",
        "- New feature: You can now cap mass extractors with storage by right-clicking a T2 or T3 mex, or double-shift-right-clicking an upgrading T1",
        "  or T2 mex, with an Engineer",
        ...
        "- Fixed the Cybran ACU wandering off long distance when told to assist various buildings with an enemy in the rough vicinity. It will still",
        "  happen if the unit is much closer, but we should no longer have ACUs walking across the map to go kill themselves on enemy PD",
