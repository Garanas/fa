...
--                                                 Source: docs/_posts/2023-03-18-3756.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-03-18-3756",
    description = {
        ...
        "## Features",
        "",
        "- (#4770) Overhaul of the cheat menu The menu now inherits from the Window class, as a result it can be moved around and rescaled. Units can",
        "  now be dragged into the game, instead of the old box spawn formation. Includes a section to spawn in props, meshes and a new section to",
        "  preview and spawn in entire templates.",
        "",
