...
--                                                 Source: docs/_posts/2017-09-24-3688.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2017-09-24-3688",
    description = {
        ...
        "",
        "- Veterancy",
        "  - Until now the veterancy system worked in such a way that the tech level of the units killed determined how many veterancy points a unit",
        "    was given, and only the unit that got the killing blow would get the veterancy point(s).",
        "  - With this patch we are moving from that tech based system to a mass based system. That means your units will get veterancy based on the",
        "    mass of the unit that is killed. Your unit also doesn't need to get the killing blow to get veterancy. Once a unit dies all the units",
        "    which damaged it will get veterancy points based on how much damage they did to that unit. There are also multipliers to adjust how much",
        "    veterancy certain classes of units will require to vet up. We will watch closely for cases where veterancy may move to fast or too slow",
        "    in certain fights and make any adjustments necessary in upcoming patches.",
        "  - The mass value of the ACU has been reduced to 2000 to avoid getting insane veterancy by killing an ACU",
        "  - The amount of veterancy points that the ACU gains from higher tech units is reduced to avoid vetting too fast by overcharging mass heavy",
        "    land units.",
