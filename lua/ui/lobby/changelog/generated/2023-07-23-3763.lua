...
--                                                 Source: docs/_posts/2023-07-23-3763.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-07-23-3763",
    description = {
        "# Game version 3763 (23th of July, 2023)",
        "",
        "See the patch notes of 3762 and 3758 for the full patch notes.",
        "",
        "There was a misconception with the distribution of files and as a result, wrecks would be removed in the release branch when you build on",
        "top of them. It was fun while it lasted ^^",
        "",
        "Jip",
        "",
        "## Features",
