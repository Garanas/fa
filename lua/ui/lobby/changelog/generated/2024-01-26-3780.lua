...
--                                                 Source: docs/_posts/2024-01-26-3780.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2024-01-26-3780",
    description = {
        ...
        "",
        "The bug occurs when the ACU attempts to use Auto Overcharge while enhancing. The Auto Overcharge behavior will be turned off but the UI was",
        "not updated accordingly. The UI now reflects this behavior.",
        "",
        ...
        "",
        "The rating shows in the lobby and in-game. The rating adjusts depending on whether it is a cheating AI, the cheating modifiers and the size",
        "of the map.",
        "",
