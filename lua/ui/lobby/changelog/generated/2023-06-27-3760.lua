...
--                                                 Source: docs/_posts/2023-06-27-3760.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-06-27-3760",
    description = {
        "# Game version 3760 (27th of June, 2023)",
        "",
        "See the patch notes of 3758 for all the details of the second development iteration.",
        "",
        "We would like to remind people that we're always open to feedback. You can get in touch with us through the forums, Discord and of course",
        "through GitHub to discuss the patch.",
        "",
        ...
        "",
        "  The rehost functionality has been broken for quite a long time. It would not properly restart the game with the correct mods and",
        "  previously private lobbies would become public. We've not managed to fix it for quite some time and it confuses those who use it.",
        "  Therefore we've decided to remove it until we can find a proper fix.",
        "",
