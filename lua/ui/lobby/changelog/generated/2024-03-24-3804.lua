...
--                                                 Source: docs/_posts/2024-03-24-3804.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2024-03-24-3804",
    description = {
        "# Game Version 3804",
        "",
        "Fixes various issues that were introduced in the past game versions. The most notable issue is the bug where the fog of war is not removed",
        "when a game ends.",
        "",
        ...
        "",
        "The exploit was that a player could assign attack orders to (mobile) units that you lack any form of intel of as long as you control one",
        "unit that has an attack order that you can distribute and/or copy.",
        "",
        "## Features",
        "",
        "- (#6009) Add separate hotkeys to select all normal bombers and all torpedo bombers",
        "",
        "  They can be found in the Selection category of the hotkeys as \"Select all Bombers (Normal)\" and \"Select all Bombers (Torpedo)\". Selecting",
        "  normal bombers excludes the Mercy, as it is a kamikaze missile.",
        "",
        ...
        "",
        "The context-based templates feature generates and adjusts templates based on the context of your mouse. Globally speaking, this is one of",
        "two categories:",
        "",
        "- (1) Mouse is over a unit or a build order",
        "",
        "In this case the first template will always be the first buildable version of the unit that you're hovering over. Then additional templates",
        "may be introduced for common tasks, such as capping an extractor with storages.",
        "",
        ...
        "",
        "- (#6005) Remove the `BUILTBYEXPERIMENTALSUB` category from all units that previously had it. As this category was unused, the Tempest still",
        "  functions as you would expect.",
        "",
        "- (#6006) Remove the `MASSFABRICATION` category from all ACUs, SACUs and the Paragon. Add the `ANTIMISSILE` category to the Seraphim",
        "  Aircraft Carrier.",
        "",
