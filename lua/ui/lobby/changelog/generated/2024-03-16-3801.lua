...
--                                                 Source: docs/_posts/2024-03-16-3801.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2024-03-16-3801",
    description = {
        "# Game Version 3801 (16th of March, 2024)",
        "",
        "The first development iteration of 2024 is here!",
        "",
        "There's a lot of goodies in this iteration. Most notably this developers iteration is also soaked with various balance changes. From 2024",
        "and onwards we no longer have separate development and balance patches.",
        "",
        "The in-game changelog will no longer include all the details of the changes. You can find the complete changelog on Github. You can use the",
        "button in the bottom-left corner of this dialog to immediately jump to details of the changes of the selected game version.",
        "",
        "With gratitude to all those who took the time to contribute,",
        "",
        "Jip",
        "",
        "_One does wonder - how did we jump from game version 3780 to 3801? The answer is simple - we did a whoopsie and pushed game version 3800",
        "instead of 3780 to the FAF Develop game type. Now, it won't update the game type unless the game version is equal or more than 3800. As game",
        "version 3800 is already occupied we now have game version 3801._",
        "",
        "## Bug Fixes",
        "",
        ...
        "",
        "  The projectile count was excessive and a large quantity of torpedo bombers could consume a significant chunk of the available budget for",
        "  the simulation. At the same time we increase the projectile count of the Solace to make it less susceptible by torpedo defenses.",
        "",
        ...
        "",
        "  Additionally, the Solace's MaxRadius and MuzzleSalvoDelay are reduced to decrease the likelihood of it dropping its torpedoes over",
        "  terrain. Its RateOfFire and BreakOffDistance stats are increased to prevent it from sometimes failing to drop its payload, or dropping it",
        "  on top of or behind ships. Effective DPS stays roughly the same.",
        "",
        "  - Solace (XAA0306): reduce its range from 32 to 26; reduce its MuzzleSalvoDelay from 0.4 to 0.2; increase it's BreakOffDistance from 42 to",
        "    44; decrease its reload time from 12.5 down to 10 seconds.",
        "",
        "- (#5910) Adjust the pathfinding behavior of the Blaze",
        "",
        "  The main weapon is now a turret like the majority of the units. As a result the weapon no longer negatively influences the pathfinding",
        "  behavior of the unit. To compensate the hitpoints of the Blaze is reduced from 1100 to 1000.",
        "",
        ...
        "",
        "  In addition to gaining the ability to move backwards, the Seraphim Tech 2 Sonar gets its TurnRate stat tripled from 20 to 60 (Tech 3",
        "  Sonars have 100), and its movement speed increased by 12%, as it was very sluggish to use.",
        "",
        ...
        "",
        "  Teleport duration and energy costs now increase as you're trying to jump further. The minimum is a duration of 15 seconds at a cost of",
        "  5.000 energy per second. The maximum is a duration of 50 seconds at a cost of 50.000 energy per second. The maximum can only be reached on",
        "  maps of size 40x40 or larger.",
        "",
        "  This is implemented as an alternative to a maximum teleport range. This implementation still allows people to jump as far as they wish but",
        "  they're naturally constrained by their own economy.",
        "",
        "  The expected costs of the teleport are displayed next to the cursor when you're trying to issue a teleport order. This uses the distance",
        "  from the world position of the cursor to the unit. When you hold shift it instead uses the distance from the world position of the cursor",
        "  to the last move and/or teleport order of the unit.",
        "",
        ...
        "",
        "  The templates you are cycling through are now preserved until you exit command mode. That means once you enter command mode by cycling you",
        "  keep on cycling through the same templates.",
        "",
        "- (#5846, #5915) Further improvements to the behavior of tactical missiles.",
        "",
        "  A single (non-aeon) tactical missile defense can now protect itself against a missile with 2 hit points again. In general Aeon, UEF and",
        "  Cybran missiles have a reduced velocity. The Seraphim missiles still have the same velocity, but decrease in velocity as they get closer",
        "  to the target.",
        "",
        ...
        "",
        "  With thanks to Ajamajan the Mongoose, Frigate and Destroyer finally received the attention that they need. The quality of the textures of",
        "  the first level of detail (LOD0) have improved significantly and the units are now visually on-par with the rest of the UEF arsenal.",
        "",
        ...
        "",
        "  All significant tactical missiles now have separate faction-specific effects from insignificant tactical missiles. This makes it easier to",
        "  understand the origin of the tactical missile. Significant tactical missiles also have a larger strategic icon (4 pixels instead of 1 or",
        "  2). The Billy has a new, unique strategic icon.",
        "",
        "## AI",
        "",
        ...
        "",
        "- #5942, #5966, #5968, #5969, #5965, #5967, #5964) Update the categories of various units.",
        "",
        ...
        "",
        "  This was most notable for players with many user-made build templates. All the user-made build templates would be deep copied for each new",
        "  selection. The average user-made build template easily has a footprint of several kilobytes in memory. With all the user-made build",
        "  templates combined it could rack up to a megabyte worth of copied memory.",
        "",
