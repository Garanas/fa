...
--                                                 Source: docs/_posts/2015-08-19-3650.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2015-08-19-3650",
    description = {
        ...
        "",
        "- It is annoying when sniper bots lose all their damage while moving and trying to shoot. They will hit more often now, even - though using",
        "  them stationary will still lead to the best results.",
        ...
        "",
        "  - The bug that caused resources to disappear when they got shared to several teammates and one of them had full storage does not exist and",
        "    is a FAF urban legend. If a teammate has full storage, the resources get properly shared to a different teammate instead. It is not",
        "    needed to use any mods to prevent resources from getting lost or to inform others about this \"bug\".",
        "  - No change required"
    }
}
