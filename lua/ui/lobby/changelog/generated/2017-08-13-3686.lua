...
--                                                 Source: docs/_posts/2017-08-13-3686.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2017-08-13-3686",
    description = {
        ...
        "    - Support for sending notifications about ACU upgrades, Factory Tech upgrades (HQs), Experimental construction, and Nuke and T3",
        ...
        "    - Notify messages limited to only show the first of each HQ type, Experimental (Non game-ender), Nuke, or T3 Artillery to avoid spamming",
        "      the chat with notifications late-game",
        "  - Notify UI",
        ...
        "    - All message types are broadcast at all times. The menu allows you to customise which messages you see, using toggle buttons at the top",
        "      of the customise.",
        ...
        "    - Unfortunately, due to an engine limitation, upgrades cannot be UN-queued (You can only stop the ACU, cancelling the in progress work",
        "      orders)",
        ...
        "### UI",
        "",
        "- Added full support for UTF character set in the lobby, game chat, and other typing interfaces. This enables Russian, Chinese, Japanese,",
