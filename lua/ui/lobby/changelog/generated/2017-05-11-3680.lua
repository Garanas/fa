...
--                                                 Source: docs/_posts/2017-05-11-3680.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2017-05-11-3680",
    description = {
        "# Patch 3680 (11th May 2017)",
        "",
        "### Gameplay",
        "",
        "- New feature: Dead air unit wrecks now bounce off shields. The amount of bounce depends on the unit's momentum and angle of approach. Some",
        "  of the crash damage is transferred to the shield. Unit wrecks can only bounce once. Doesn't affect Experimentals.",
        ...
        "- Enabled fire states on TML and SML structures and units. This allows you to command multiple launchers to fire simultaneously at multiple",
        "  targets",
        ...
        "- Observers are now kicked before checking connection issues when Allow Observers is false. This means they will no longer stall game launch",
        "  if one or more have a connection issue.",
        ...
        "- Added a 'New Message' button to the lobby which jumps to bottom of chat, and disabled the chat auto-hopping to bottom with every new",
        ...
        "- Added Hotbuild Preset button. This will automatically set your bindings to the Hotbuild Preset. There is also a button to set back to",
        "  Default Preset.",
