...
--                                                 Source: docs/_posts/2021-05-14-3720.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2021-05-14-3720",
    description = {
        ...
        "  - Overcharge",
        "    - Overcharge kills mobile land shield generators if it depletes its shield on impact (only a single one, overspilled ones live).",
        "      Veterancy counted, no reclaim left.",
        "  - Artillery damage",
