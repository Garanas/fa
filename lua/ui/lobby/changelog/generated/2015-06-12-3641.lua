...
--                                                 Source: docs/_posts/2015-06-12-3641.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2015-06-12-3641",
    description = {
        ...
        "- Absolver shield disruptor now hovers higher, so it's less likely to hit the floor with the very low mounted gun",
        "- UEF SCU Drone can now capture, the same as the ACU ones",
        "- Tiny changes to make Fatboy/Megalith/Spiderbot weapons symmetrical in behavior where they should be",
