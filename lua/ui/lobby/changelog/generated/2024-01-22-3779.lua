...
--                                                 Source: docs/_posts/2024-01-22-3779.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2024-01-22-3779",
    description = {
        ...
        "",
        "The deflector weapon of the Loyalist allows it to take ownership of incoming tactical missiles and return them to the unit that fired it.",
        "With the new implementation the missiles that are send back have switched army and can therefore be intercepted by Tactical Missile Defenses",
        "(TMDs) and shields.",
        "",
        ...
        "",
        "The movement reduction of the sniper mode is now only applied when the main weapon is on cooldown. This reduces the amount of micro that is",
        "required to use the sniper.",
        "",
        ...
        "",
        "The Seraphim faction lacks a Resource Allocation Subsystem (RAS) for the SACU. We understand that players may feel disadvantaged when",
        "playing Seraphim in the very-late game phase where RAS SACUs can play an important role. With these changes, we preserve the faction",
        "diversity while providing the Seraphim faction with an alternative approach to generate mobile resources.",
        "",
        ...
        "",
        "This is a complicated but interesting change. For the player, intel is visualized as a perfect circle. However, for the engine, intel is",
        "processed in a grid. The grid is coarse - the size of a cell for vision is 2 walls, and for all other types of (counter) intel, it is 4",
        "walls.",
        "",
        "This has consequences. Imagine four units with a radar radius of 28, 29, 30, and 31. Visually, it appears that the last unit with a radar",
        "radius of 31 provides more intel than the unit with a radar radius of 28. For the engine, however, because the size of a cell in the intel",
        "grid is 4 walls large, it doesn't matter - the units with 29, 30, and 31 radar range provide as much intel as the unit with 28 radar range.",
        "",
        "With these changes, we reviewed all intel radii to ensure the value aligns with the value that the intel grid actually applies. As a result,",
        "the intel radius of units may appear smaller, but for the engine, they are the same. Therefore, the intel radii that you see now are more",
        "accurate.",
        "",
        ...
        "",
        "In the average case, intel would only update every 3 seconds (or 30 ticks). With thanks to an assembly patch, intel now updates every 0.5",
        "seconds (or 5 ticks). This impacts not just what you see as a player but also how quickly the weapons of your units may react to blips that",
        "suddenly pop up in their range.",
        "",
        "- (#5836) Revert of the 15% global vision range increase as introduced by game version 3761",
        "",
        "The vision range of various units was increased because of the slow update frequency of intel. With thanks to the assembly patch, the update",
        "frequency of intel is increased with 600%, and therefore, we're reverting the global vision range increase.",
        "",
        "- (#5848) Remove the friendly fire of the Ravager.",
        "",
        "- (#5789) Adjust the behavior of the Billy.",
        "",
        "The Billy no longer explodes in the first 2.5 seconds of its lifespan. The damage of the Billy no longer pierces shields, reversing an",
        "accidental change.",
        "",
        "## Bug Fixes",
        "",
        ...
        "",
        "The Volcano could try to intercept missiles that it would never be able to. Given that TMDs try not to overshoot their target, the behavior",
        "would cause other TMDs to ignore the missile.",
        "",
        ...
        "",
        "You can now assist a tech 2 mass extractor with some adjacency to start an upgrade to tech 3. You can now assist a radar to start an",
        "upgrade. Requires some adjacency for a tech 2 radar.",
        "",
        ...
        "",
        "There's a standard reload time that applies. This is most notable for the Billy. The hatch animation acts as a rough indication for this",
        "reload time.",
        "",
