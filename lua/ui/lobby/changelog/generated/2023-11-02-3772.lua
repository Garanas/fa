...
--                                                 Source: docs/_posts/2023-11-02-3772.md                                                 --
--------------------------------------------------------------------------------------------------------------------------------------------
Changelog = {
    version = "2023-11-02-3772",
    description = {
        ...
        "",
        "With the latest patch, walls now reliably block projectiles, even for units hiding behind them. This can create nearly impenetrable defenses",
        "without the need for artillery. In collaboration with the balance team, we have decided to implement the following balance changes for all",
        "wall sections:",
        "",
        "- - Health: X -> 500",
        "",
        ...
        "",
        "In the recent patch, units no longer automatically rotate towards the optimal rollout point upon completing construction. The old behavior,",
        "especially noticeable with large units (e.g., naval units), could be quite awkward. We have decided to make an exception for engineers since",
        "an incorrectly oriented engineer at the beginning of the game can significantly slow down your build order, costing valuable seconds.",
        "",
        "### AI",
        "",
        ...
        "",
        "Factory modules are still part of the objective. It is up to the author of the campaign map to exclude them in the script files if they do",
        "not want them to be part of the objective",
        "",
        ...
        "",
        "This bug was addressed through an assembly patch, which was noticeable due to water splashes appearing on land. This issue was particularly",
        "prominent with transports crashing, but it also affected the average projectile, creating small water splashes.",
        "",
